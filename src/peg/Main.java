...
public class Main {
	public static void main(String args[]) {
		...
		Engine E;
		Peg_game T = new Peg_game();
		T.eval();
		E = new Engine(T);
						
		System.out.println("========== INIZIO =======");
		System.out.println(T.toPrintString());
		...
		if(T!=null)System.out.println(T.toPrintString());
	...
	public static void TraceBack(Peg_game g){ 
		...
		TraceBack(g.father);
		System.out.println(g.toPrintString());
	...
	final static Board[][] peg_europeo = 
										{{E,E,P,P,P,E,E},
										{E,P,P,P,P,P,E},
										{P,P,P,P,P,P,P},
										{P,P,P,V,P,P,P},
	...
	final static Board[][] peg_per_bambini = 
											{{E,E,V,V,V,E,E},
											{E,E,V,V,P,E,E},
											{V,V,V,V,P,V,V},
											{V,V,V,V,V,V,V},
